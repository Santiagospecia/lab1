...
LiquidCrystal lcd(9); //inicializar la biblioteca con el numero de sspin o el lanch pin del 74hc595
...
void setup() {
  ...
  lcd.begin(16, 2); //configura el numero de filas y columnas del lcd
  lcd.print ("¡BIENVENIDO!"); //imprime mensaje de bienvenida 
...
void loop() {
  ...
  // (**la línea 1 es la segunda fila, ya que el conteo empieza con 0): 
  lcd.setCursor (0, 1);
